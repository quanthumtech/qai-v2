export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de QAI CLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de QAI CLI. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de QAI CLI",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de QAI CLI. Intenta reinstalar la aplicación de escritorio.",
