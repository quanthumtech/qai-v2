export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию QAI CLI",
  ...
  "desktop.updater.downloaded.prompt": "Версия QAI CLI {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.menu.help.documentation": "Документация QAI CLI",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл QAI CLI CLI. Попробуйте переустановить настольное приложение.",
