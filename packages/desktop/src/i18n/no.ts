export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av QAI CLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av QAI CLI er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "QAI CLI Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "QAI CLI CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
