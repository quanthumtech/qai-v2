export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの QAI CLI を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "QAI CLI のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "QAI CLI ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "QAI CLI CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
