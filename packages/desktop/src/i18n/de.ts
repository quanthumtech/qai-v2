export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von QAI CLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von QAI CLI wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das QAI CLI CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
