export const dict = {
  ...
  "desktop.menu.help.documentation": "QAI CLI Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of QAI CLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of QAI CLI has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "QAI CLI binary is missing. Try reinstalling the desktop app.",
