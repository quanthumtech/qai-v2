export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji QAI CLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} QAI CLI. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja QAI CLI",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego QAI CLI CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
