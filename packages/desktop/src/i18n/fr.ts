export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'QAI CLI",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'QAI CLI a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'QAI CLI",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI QAI CLI est manquant. Essayez de réinstaller l'application de bureau.",
