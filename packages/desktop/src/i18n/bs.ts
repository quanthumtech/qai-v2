export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju QAI CLI-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} QAI CLI-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "QAI CLI Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka QAI CLI CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
