export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af QAI CLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af QAI CLI er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.menu.help.documentation": "QAI CLI Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "QAI CLI CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
