export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من QAI CLI",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من QAI CLI، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق QAI CLI",
  ...
  "desktop.cli.error.sidecarMissing": "ملف QAI CLI CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
