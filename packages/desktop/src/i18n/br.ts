export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do QAI CLI",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do QAI CLI foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do QAI CLI",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do QAI CLI está ausente. Tente reinstalar o aplicativo de desktop.",
